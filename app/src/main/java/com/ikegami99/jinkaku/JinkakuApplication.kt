...
class JinkakuApplication : Application() {
    ...
    override fun onCreate() {
        ...
        // Vulkan is available again as an explicit experimental backend.
        // Keep OpenCL as the stable default; backend selection is handled in JNI.
        runCatching { Os.unsetenv("GGML_DISABLE_VULKAN") }
        ...
        logger.i(
            "APP",
            "Native backend env VulkanDisabled=${System.getenv("GGML_DISABLE_VULKAN") ?: "0"} " +
